...
/**
 * 以 customIcons 為參數動態產生播放器 HTML 字串。
 * 圖示 URL 由 path-resolver.js 根據 import.meta.url 自動計算，無需傳入路徑。
 *
 * @param {Object} customIcons
 * @returns {string}
 */
export function buildTemplate(customIcons = {}) {
    ...
    <div class="music-container">
      ...
      <div class="music-list-container">
        <div class="list-title-container">
          <img src="${icon("icon-music.svg")}" alt="音樂" class="list-title-icon">
...
/**
 * 取得 shadowRoot 中各元素的參考，供 Controller 掛載事件。
 * @param {ShadowRoot} shadowRoot
 * @returns {Object}
 */
export function initElements(shadowRoot) {
